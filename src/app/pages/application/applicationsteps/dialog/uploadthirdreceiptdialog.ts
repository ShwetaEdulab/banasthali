...
selector: 'nb-dialog',
template: `
<nb-card [style.width.px]="500" [style.height.px]="300" status="success" accent="success" size="xsmall" [nbSpinner]="loading" nbSpinnerStatus="success" nbSpinnerSize="xlarge">
  <nb-card-header>
    <div class="row">
      <div class="col-md-1">
      </div>
