  ...
  async ngOnInit() {
    ...
    .subscribe((token: NbAuthJWTToken) => {
      this.user_id = token.getPayload()['id'];
        ...
        }else if(token.getPayload()['role'] == "dte"){
          this.router.navigate(['pages/DTEDashboard'])
        }
    });
    ...
    this.userService.onUserChange()
      ...
      if(this.user.role == 'student'){
        ...
        applications.subscribe(data =>{
          ...
          this.api.trackerChecktab(this.applicationID).subscribe(data => {
