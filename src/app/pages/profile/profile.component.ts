...
export class ProfileComponent {
      ...
      .subscribe(
        (data: any) => {
          if (data['data']['cbse'] != null) {
            ...
            // this.thirdForm.controls.cbseUniversityCtrl.setValue = data['data']['cbse']['university'];
  ...
  onFirstSubmit(country_birth) {
    ...
    || (this.firstForm.controls.altCountryCtrl.value =='' || this.firstForm.controls.altCountryCtrl.value ==null || this.firstForm.controls.altCountryCtrl.value ==undefined	)){
      ...
      if( this.countryofbirth != 154 || this.countryofbirth != 25){
				...
				var expiryMonnth = passExpiryDate.getUTCMonth();
				var expiryYear = passExpiryDate.getUTCFullYear();
				var issueDay = passIssueDate.getUTCDate();
				var issueMonnth = passIssueDate.getUTCMonth();
        var issueYear = passIssueDate.getUTCFullYear();
  ...
  onThirdSubmit() {
    if(this.edudegreecheck == null || this.edudegreecheck == "Bachelor's" ){
      if(this.hsc.college_university == '' || this.hsc == null || this.cbse.university == '' || this.cbse == null){
        ...
        //this.thirdForm.controls.cbseUniversityCtrl.setValue(this.cbse.university);
  ...
  sampleDownload1(){
    var data = '/srv/www/mumbaiserver/public/upload/SampleDocuments/BankStatementAffidavit.pdf';
    this.adminApi.downloadFiles(data)
      .subscribe(data => {
        saveAs(data, 'BankStatementAffidavit.pdf');    
      });
