...
//dte
import { DTEDashboardComponent } from '../DTE/dtedashboard/dtedashboard.component';
import { DTEProfileComponent } from '../DTE/dteprofile/dteprofile.component';
import { DTEMyApplicationComponent } from '../DTE/dtemy-application/dtemy-application.component';
import { DTESearchComponent } from '../DTE/dtesearch/dtesearch.component';
import { DteCourseComponent } from '../DTE/dtecourse/dtecourse.component';
import { DTECartComponent } from '../DTE/dtecart/dtecart.component';
...
const routes: Routes = [{
  ...
  {
    path: 'DTEDashboard',
    component: DTEDashboardComponent,

  }, 
   {
    path: 'DTEMyApplication',
    component: DTEMyApplicationComponent,

  },
  {
    path: 'DTEProfile',
    component: DTEProfileComponent,

  },
  {
    path: 'DTESearch',
    component: DTESearchComponent,

  }, 
  {
    path: 'DteCourse',
    component: DteCourseComponent,

  },
  {
    path: 'DTECart',
    component: DTECartComponent,
