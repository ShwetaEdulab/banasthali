...
<div class="row">
  ...
  <form [formGroup]="degree_form"  class="step-container">
    <div class="row">
      ...
      <div class="col-md-2"><input  ngModel="{{degree_marks?.degree_Subject_first_deg}}" name="Subject_firsth_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.subjectFirstDegCtrl.invalid && (degree_form.controls.subjectFirstDegCtrl.dirty || degree_form.controls.subjectFirstDegCtrl.touched)}" formControlName="subjectFirstDegCtrl" placeholder="Subject1" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_mark_first_deg}}" name="mark_firsth_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.markFirstDegCtrl.invalid && (degree_form.controls.markFirstDegCtrl.dirty || degree_form.controls.markFirstDegCtrl.touched)}" formControlName="markFirstDegCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_OutOf_first_deg}}" name="OutOf_firsth_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.outOfFirstDegCtrl.invalid && (degree_form.controls.outOfFirstDegCtrl.dirty || degree_form.controls.outOfFirstDegCtrl.touched)}" formControlName="outOfFirstDegCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': degree_form.controls.gradeFirstDegCtrl.invalid && (degree_form.controls.gradeFirstDegCtrl.dirty || degree_form.controls.gradeFourthDegCtrl.touched)}"  ngModel="{{degree_marks?.degree_grade_first_deg}}" name="grade_firsth_deg" nbInput type="text" formControlName="gradeFirstDegCtrl"  placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{degree_marks?.degree_Subject_Second_deg}}" name="Subject_two_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.subjectSecondDegCtrl.invalid && (degree_form.controls.subjectSecondDegCtrl.dirty || degree_form.controls.subjectSecondDegCtrl.touched)}" formControlName="subjectSecondDegCtrl" placeholder="Subject2" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_mark_Second_deg}}" name="mark_two_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.markSecondDegCtrl.invalid && (degree_form.controls.markSecondDegCtrl.dirty || degree_form.controls.markSecondDegCtrl.touched)}" formControlName="markSecondDegCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_OutOf_Second_deg}}" name="OutOf_two_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.outOfSecondDegCtrl.invalid && (degree_form.controls.outOfSecondDegCtrl.dirty || degree_form.controls.outOfSecondDegCtrl.touched)}" formControlName="outOfSecondDegCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': degree_form.controls.gradeSecondDegCtrl.invalid && (degree_form.controls.gradeSecondDegCtrl.dirty || degree_form.controls.gradeSecondDegCtrl.touched)}" ngModel="{{degree_marks?.degree_grade_Second_deg}}" name="grade_two_deg" nbInput type="text"  formControlName="gradeSecondDegCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{degree_marks?.degree_Subject_Third_deg}}" name="Subject_third_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.subjectThirdDegCtrl.invalid && (degree_form.controls.subjectThirdDegCtrl.dirty || degree_form.controls.subjectThirdDegCtrl.touched)}" formControlName="subjectThirdDegCtrl" placeholder="Subject3" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_mark_Third_deg}}" name="mark_third_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.markThirdDegCtrl.invalid && (degree_form.controls.markThirdDegCtrl.dirty || degree_form.controls.markThirdDegCtrl.touched)}" formControlName="markThirdDegCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_OutOf_Third_deg}}" name="OutOf_third_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.outOfThirdDegCtrl.invalid && (degree_form.controls.outOfThirdDegCtrl.dirty || degree_form.controls.outOfThirdDegCtrl.touched)}" formControlName="outOfThirdDegCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': degree_form.controls.gradeThirdDegCtrl.invalid && (degree_form.controls.gradeThirdDegCtrl.dirty || degree_form.controls.gradeThirdDegCtrl.touched)}" ngModel="{{degree_marks?.degree_grade_Third_deg}}" name="grade_third_deg" nbInput type="text" formControlName="gradeThirdDegCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{degree_marks?.degree_Subject_fourth_deg}}" name="Subject_fourth_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.subjectFourthDegCtrl.invalid && (degree_form.controls.subjectFourthDegCtrl.dirty || degree_form.controls.subjectFourthDegCtrl.touched)}" formControlName="subjectFourthDegCtrl" placeholder="Subject4" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_mark_fourth_deg}}" name="mark_fourth_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.markFourthDegCtrl.invalid && (degree_form.controls.markFourthDegCtrl.dirty || degree_form.controls.markFourthDegCtrl.touched)}" formControlName="markFourthDegCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_OutOf_fourth_deg}}" name="OutOf_fourth_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.outOfFourthDegCtrl.invalid && (degree_form.controls.outOfFourthDegCtrl.dirty || degree_form.controls.outOfFourthDegCtrl.touched)}" formControlName="outOfFourthDegCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': degree_form.controls.gradeFourthDegCtrl.invalid && (degree_form.controls.gradeFourthDegCtrl.dirty || degree_form.controls.gradeFourthDegCtrl.touched)}" ngModel="{{degree_marks?.degree_grade_fourth_deg}}" name="grade_fourth_deg" nbInput type="text" formControlName="gradeFourthDegCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      ...
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_mark_fifth_deg}}" [ngClass]="{'form-control-danger': degree_form.controls.markFifthDegCtrl.invalid && (degree_form.controls.markFifthDegCtrl.dirty || degree_form.controls.markFifthDegCtrl.touched)}" name="mark_fifth_deg" nbInput type="text" formControlName="markFifthDegCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_OutOf_fifth_deg}}" [ngClass]="{'form-control-danger': degree_form.controls.outOfFifthDegCtrl.invalid && (degree_form.controls.outOfFifthDegCtrl.dirty || degree_form.controls.outOfFifthDegCtrl.touched)}" name="OutOf_fifth_deg" nbInput type="text" formControlName="outOfFifthDegCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input ngModel="{{degree_marks?.degree_grade_fifth_deg}}" [ngClass]="{'form-control-danger': degree_form.controls.gradeFifthDegCtrl.invalid && (degree_form.controls.gradeFifthDegCtrl.dirty || degree_form.controls.gradeFifthDegCtrl.touched)}" name="grade_fifth_deg" nbInput type="text" formControlName="gradeFifthDegCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{degree_marks?.degree_Subject_Six_deg}}" name="Subject_Six_deg" [ngClass]="{'form-control-danger': degree_form.controls.subjectSixthDegCtrl.invalid && (degree_form.controls.subjectSixthDegCtrl.dirty || degree_form.controls.subjectSixthDegCtrl.touched)}" nbInput type="text" formControlName="subjectSixthDegCtrl" placeholder="Subject6" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_mark_Six_deg}}" [ngClass]="{'form-control-danger': degree_form.controls.markSixthDegCtrl.invalid && (degree_form.controls.markSixthDegCtrl.dirty || degree_form.controls.markSixthDegCtrl.touched)}" name="mark_Six_deg" nbInput type="text" formControlName="markSixthDegCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{degree_marks?.degree_OutOf_Six_deg}}" [ngClass]="{'form-control-danger': degree_form.controls.outOfSixthDegCtrl.invalid && (degree_form.controls.outOfSixthDegCtrl.dirty || degree_form.controls.outOfSixthDegCtrl.touched)}" name="OutOf_Six_deg" nbInput type="text" formControlName="outOfSixthDegCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input ngModel="{{degree_marks?.degree_grade_Six_deg}}" name="grade_Six_deg" nbInput type="text" [ngClass]="{'form-control-danger': degree_form.controls.gradeSixthDegCtrl.invalid && (degree_form.controls.gradeSixthDegCtrl.dirty || degree_form.controls.gradeSixthDegCtrl.touched)}" formControlName="gradeSixthDegCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
...
constructor(protected ref: NbDialogRef<FourthDialogComponent>,
    ...
    if(parseInt(this.degree_form.controls.markSixthDegCtrl.value) > parseInt(this.degree_form.controls.outOfSixthDegCtrl.value) ){
     ...
     if( this.degree_form.valid && validation){
      ...
      var degreee_data ={
        ...
        this.dte_api.setProfileValues(degreee_data,'Education_Degree')
        .subscribe(
          (data: any) => {  
  ...
  private buildDegreeForm() : void{
    ...
    this.dte_api.getProfileValue('Education_degree')
      .subscribe(
        (data: any) => {  
