...
<div class="row">
  ...
  <form [formGroup]="diploma_form"  class="step-container">
    <div class="row">
      ...
      <div class="col-md-2"><input  ngModel="{{diploma_marks?.diploma_Subject_first_dip}}" nbInput type="text"  [ngClass]="{'form-control-danger': diploma_form.controls.subjectFirstDipCtrl.invalid && (diploma_form.controls.subjectFirstDipCtrl.dirty || diploma_form.controls.subjectFirstDipCtrl.touched)}" formControlName="subjectFirstDipCtrl" placeholder="Subject1" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_mark_first_dip}}" nbInput type="text"  [ngClass]="{'form-control-danger': diploma_form.controls.markFirstDipCtrl.invalid && (diploma_form.controls.markFirstDipCtrl.dirty || diploma_form.controls.markFirstDipCtrl.touched)}" formControlName="markFirstDipCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_OutOf_first_dip}}" nbInput type="text"  [ngClass]="{'form-control-danger': diploma_form.controls.outOfFirstDipCtrl.invalid && (diploma_form.controls.outOfFirstDipCtrl.dirty || diploma_form.controls.outOfFirstDipCtrl.touched)}" formControlName="outOfFirstDipCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': diploma_form.controls.gradeFirstDipCtrl.invalid && (diploma_form.controls.gradeFirstDipCtrl.dirty || diploma_form.controls.gradeFourthDipCtrl.touched)}"  ngModel="{{diploma_marks?.diploma_grade_first_dip}}" nbInput type="text"  formControlName="gradeFirstDipCtrl"  placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{diploma_marks?.diploma_Subject_Second_dip}}" nbInput type="text"  [ngClass]="{'form-control-danger': diploma_form.controls.subjectSecondDipCtrl.invalid && (diploma_form.controls.subjectSecondDipCtrl.dirty || diploma_form.controls.subjectSecondDipCtrl.touched)}" formControlName="subjectSecondDipCtrl" placeholder="Subject2" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_mark_Second_dip}}" nbInput type="text"  [ngClass]="{'form-control-danger': diploma_form.controls.markSecondDipCtrl.invalid && (diploma_form.controls.markSecondDipCtrl.dirty || diploma_form.controls.markSecondDipCtrl.touched)}" formControlName="markSecondDipCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_OutOf_Second_dip}}" nbInput type="text"  [ngClass]="{'form-control-danger': diploma_form.controls.outOfSecondDipCtrl.invalid && (diploma_form.controls.outOfSecondDipCtrl.dirty || diploma_form.controls.outOfSecondDipCtrl.touched)}" formControlName="outOfSecondDipCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': diploma_form.controls.gradeSecondDipCtrl.invalid && (diploma_form.controls.gradeSecondDipCtrl.dirty || diploma_form.controls.gradeSecondDipCtrl.touched)}" ngModel="{{diploma_marks?.diploma_grade_Second_dip}}" nbInput type="text"  formControlName="gradeSecondDipCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{diploma_marks?.diploma_Subject_Third_dip}}" nbInput type="text" [ngClass]="{'form-control-danger': diploma_form.controls.subjectThirdDipCtrl.invalid && (diploma_form.controls.subjectThirdDipCtrl.dirty || diploma_form.controls.subjectThirdDipCtrl.touched)}" formControlName="subjectThirdDipCtrl" placeholder="Subject3" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_mark_Third_dip}}" nbInput type="text" [ngClass]="{'form-control-danger': diploma_form.controls.markThirdDipCtrl.invalid && (diploma_form.controls.markThirdDipCtrl.dirty || diploma_form.controls.markThirdDipCtrl.touched)}" formControlName="markThirdDipCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_OutOf_Third_dip}}" nbInput type="text" [ngClass]="{'form-control-danger': diploma_form.controls.outOfThirdDipCtrl.invalid && (diploma_form.controls.outOfThirdDipCtrl.dirty || diploma_form.controls.outOfThirdDipCtrl.touched)}" formControlName="outOfThirdDipCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': diploma_form.controls.gradeThirdDipCtrl.invalid && (diploma_form.controls.gradeThirdDipCtrl.dirty || diploma_form.controls.gradeThirdDipCtrl.touched)}" ngModel="{{diploma_marks?.diploma_grade_Third_dip}}" nbInput type="text"  formControlName="gradeThirdDipCtrl"  placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{diploma_marks?.diploma_Subject_fourth_dip}}" nbInput type="text" [ngClass]="{'form-control-danger': diploma_form.controls.subjectFourthDipCtrl.invalid && (diploma_form.controls.subjectFourthDipCtrl.dirty || diploma_form.controls.subjectFourthDipCtrl.touched)}" formControlName="subjectFourthDipCtrl" placeholder="Subject4" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_mark_fourth_dip}}" nbInput type="text" [ngClass]="{'form-control-danger': diploma_form.controls.markFourthDipCtrl.invalid && (diploma_form.controls.markFourthDipCtrl.dirty || diploma_form.controls.markFourthDipCtrl.touched)}" formControlName="markFourthDipCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_OutOf_fourth_dip}}" nbInput type="text" [ngClass]="{'form-control-danger': diploma_form.controls.outOfFourthDipCtrl.invalid && (diploma_form.controls.outOfFourthDipCtrl.dirty || diploma_form.controls.outOfFourthDipCtrl.touched)}" formControlName="outOfFourthDipCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': diploma_form.controls.gradeFourthDipCtrl.invalid && (diploma_form.controls.gradeFourthDipCtrl.dirty || diploma_form.controls.gradeFourthDipCtrl.touched)}" ngModel="{{diploma_marks?.diploma_grade_fourth_dip}}" nbInput type="text"  formControlName="gradeFourthDipCtrl"  placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{diploma_marks?.diploma_Subject_fifth_dip}}" nbInput type="text" [ngClass]="{'form-control-danger': diploma_form.controls.subjectFifthDipCtrl.invalid && (diploma_form.controls.subjectFifthDipCtrl.dirty || diploma_form.controls.subjectFifthDipCtrl.touched)}" formControlName="subjectFifthDipCtrl"  placeholder="Subject5" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_mark_fifth_dip}}" nbInput type="text" [ngClass]="{'form-control-danger': diploma_form.controls.markFifthDipCtrl.invalid && (diploma_form.controls.markFifthDipCtrl.dirty || diploma_form.controls.markFifthDipCtrl.touched)}" formControlName="markFifthDipCtrl"  placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{diploma_marks?.diploma_OutOf_fifth_dip}}" [ngClass]="{'form-control-danger': diploma_form.controls.outOfFifthDipCtrl.invalid && (diploma_form.controls.outOfFifthDipCtrl.dirty || diploma_form.controls.outOfFifthDipCtrl.touched)}" nbInput type="text"  formControlName="outOfFifthDipCtrl"  placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input ngModel="{{diploma_marks?.diploma_grade_fifth_dip}}" [ngClass]="{'form-control-danger': diploma_form.controls.gradeFifthDipCtrl.invalid && (diploma_form.controls.gradeFifthDipCtrl.dirty || diploma_form.controls.gradeFifthDipCtrl.touched)}" nbInput type="text"  formControlName="gradeFifthDipCtrl"  placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{diploma_marks?.diploma_Subject_Six_dip}}" [ngClass]="{'form-control-danger': diploma_form.controls.subjectSixthDipCtrl.invalid && (diploma_form.controls.subjectSixthDipCtrl.dirty || diploma_form.controls.subjectSixthDipCtrl.touched)}"nbInput type="text" formControlName="subjectSixthDipCtrl"  placeholder="Subject6" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" [ngClass]="{'form-control-danger': diploma_form.controls.markSixthDipCtrl.invalid && (diploma_form.controls.markSixthDipCtrl.dirty || diploma_form.controls.markSixthDipCtrl.touched)}" ngModel="{{diploma_marks?.diploma_mark_Six_dip}}" nbInput type="text" formControlName="markSixthDipCtrl"  placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" [ngClass]="{'form-control-danger': diploma_form.controls.outOfSixthDipCtrl.invalid && (diploma_form.controls.outOfSixthDipCtrl.dirty || diploma_form.controls.outOfSixthDipCtrl.touched)}" ngModel="{{diploma_marks?.diploma_OutOf_Six_dip}}" nbInput type="text" formControlName="outOfSixthDipCtrl"  placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input ngModel="{{diploma_marks?.diploma_grade_Six_dip}}" [ngClass]="{'form-control-danger': diploma_form.controls.gradeSixthDipCtrl.invalid && (diploma_form.controls.gradeSixthDipCtrl.dirty || diploma_form.controls.gradeSixthDipCtrl.touched)}" nbInput type="text" formControlName="gradeSixthDipCtrl"  placeholder="Grade" id="" class="form-control"> </div><br>
...
constructor(protected ref: NbDialogRef<ThirdDialogComponent>,
  ...
  private buildDiplomaForm() : void{
    ...
    this.dte_api.getProfileValue('Education_diploma')
      .subscribe(
        (data: any) => {  
     ...
     if( this.diploma_form.valid && validation)
      {
        var diploma_data ={
          ...
          this.dte_api.setProfileValues(diploma_data,'Education_Diploma')
          .subscribe(
            (data: any) => {  
