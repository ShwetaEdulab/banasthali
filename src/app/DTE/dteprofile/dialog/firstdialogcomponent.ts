...
<div class="row" *ngIf="id == 1 || id == '1'">
  ...
  <form [formGroup]="ssc_form"  class="step-container">
    <div class="row">
      ...
      <div class="col-md-9"> <input  ngModel="{{cbse_marks?.ssc_university}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.sscUniversityCtrl.invalid && (ssc_form.controls.sscUniversityCtrl.dirty || ssc_form.controls.sscUniversityCtrl.touched)}" formControlName="sscUniversityCtrl" placeholder="" id="" class="form-control"> </div><br>
      <div class="col-md-3">School/College Name : </div>
      <div class="col-md-9"> <input ngModel="{{cbse_marks?.ssc_school_name}}" nbInput type="text"  [ngClass]="{'form-control-danger': ssc_form.controls.sscCollegeCtrl.invalid && (ssc_form.controls.sscCollegeCtrl.dirty || ssc_form.controls.sscCollegeCtrl.touched)}" formControlName="sscCollegeCtrl" placeholder="" id="" class="form-control"> </div><br>
      ...
      <div class="col-md-9"> <input ngModel="{{cbse_marks?.ssc_school_add}}" nbInput type="text"  [ngClass]="{'form-control-danger': ssc_form.controls.sscAddCtrl.invalid && (ssc_form.controls.sscAddCtrl.dirty || ssc_form.controls.sscAddCtrl.touched)}" formControlName="sscAddCtrl" placeholder="" id="" class="form-control"> </div><br>
      ...
      <div class="col-md-9"> <input ngModel="{{cbse_marks?.ssc_school_email}}" nbInput type="text"  [ngClass]="{'form-control-danger': ssc_form.controls.sscEmailCtrl.invalid && (ssc_form.controls.sscEmailCtrl.dirty || ssc_form.controls.sscEmailCtrl.touched)}" formControlName="sscEmailCtrl" placeholder="" id="" class="form-control"> </div><br>
      <div class="col-md-3">URL : </div>
      <div class="col-md-9"> <input ngModel="{{cbse_marks?.ssc_school_url}}" pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"  nbInput type="text"  [ngClass]="{'form-control-danger': ssc_form.controls.sscUrlCtrl.invalid && (ssc_form.controls.sscUrlCtrl.dirty || ssc_form.controls.sscUrlCtrl.touched)}" formControlName="sscUrlCtrl" placeholder="" id="" class="form-control"> </div><br>
      ...
      <div class="col-md-9"> <input pattern="[A-Za-z0-9]+" ngModel="{{cbse_marks?.ssc_school_rollNo}}" nbInput type="text"  [ngClass]="{'form-control-danger': ssc_form.controls.sscRollNoCtrl.invalid && (ssc_form.controls.sscRollNoCtrl.dirty || ssc_form.controls.sscRollNoCtrl.touched)}" formControlName="sscRollNoCtrl" placeholder="" id="" class="form-control"> </div><br>
      <div class="col-md-3">Medium of Examination : </div>
      <div class="col-md-9"> <input pattern="[A-Za-z]+" ngModel="{{cbse_marks?.ssc_school_medium}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.sscMediumCtrl.invalid && (ssc_form.controls.sscMediumCtrl.dirty || ssc_form.controls.sscMediumCtrl.touched)}" formControlName="sscMediumCtrl" placeholder="" id="" class="form-control"> </div><br>

      <div class="col-md-3">Subject :</div>
      <div class="col-md-2"><input  ngModel="{{cbse_marks?.ssc_Subject_first}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.subjectFirstsscCtrl.invalid && (ssc_form.controls.subjectFirstsscCtrl.dirty || ssc_form.controls.subjectFirstsscCtrl.touched)}" formControlName="subjectFirstsscCtrl" placeholder="Subject1" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_mark_first}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.markFirstsscCtrl.invalid && (ssc_form.controls.markFirstsscCtrl.dirty || ssc_form.controls.markFirstsscCtrl.touched)}" formControlName="markFirstsscCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_OutOf_first}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.outOfFirstsscCtrl.invalid && (ssc_form.controls.outOfFirstsscCtrl.dirty || ssc_form.controls.outOfFirstsscCtrl.touched)}" formControlName="outOfFirstsscCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input  [ngClass]="{'form-control-danger': ssc_form.controls.gradeFirstsscCtrl.invalid && (ssc_form.controls.gradeFirstsscCtrl.dirty || ssc_form.controls.gradeFirstsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_grade_first}}" nbInput type="text" formControlName="gradeFirstsscCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{cbse_marks?.ssc_Subject_Second}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.subjectSecondsscCtrl.invalid && (ssc_form.controls.subjectSecondsscCtrl.dirty || ssc_form.controls.subjectSecondsscCtrl.touched)}" formControlName="subjectSecondsscCtrl" placeholder="Subject2" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_mark_Second}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.markSecondsscCtrl.invalid && (ssc_form.controls.markSecondsscCtrl.dirty || ssc_form.controls.markSecondsscCtrl.touched)}" formControlName="markSecondsscCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_OutOf_Second}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.outOfSecondsscCtrl.invalid && (ssc_form.controls.outOfSecondsscCtrl.dirty || ssc_form.controls.outOfSecondsscCtrl.touched)}" formControlName="outOfSecondsscCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input   [ngClass]="{'form-control-danger': ssc_form.controls.gradeSecondsscCtrl.invalid && (ssc_form.controls.gradeSecondsscCtrl.dirty || ssc_form.controls.gradeSecondsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_grade_Second}}" nbInput type="text" formControlName="gradeSecondsscCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{cbse_marks?.ssc_Subject_Third}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.subjectThirdsscCtrl.invalid && (ssc_form.controls.subjectThirdsscCtrl.dirty || ssc_form.controls.subjectThirdsscCtrl.touched)}" formControlName="subjectThirdsscCtrl" placeholder="Subject3" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_mark_Third}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.markThirdsscCtrl.invalid && (ssc_form.controls.markThirdsscCtrl.dirty || ssc_form.controls.markThirdsscCtrl.touched)}" formControlName="markThirdsscCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_OutOf_Third}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.outOfThirdsscCtrl.invalid && (ssc_form.controls.outOfThirdsscCtrl.dirty || ssc_form.controls.outOfThirdsscCtrl.touched)}" formControlName="outOfThirdsscCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input   ngModel="{{cbse_marks?.ssc_grade_Third}}" [ngClass]="{'form-control-danger': ssc_form.controls.gradeThirdsscCtrl.invalid && (ssc_form.controls.gradeThirdsscCtrl.dirty || ssc_form.controls.gradeThirdsscCtrl.touched)}" nbInput type="text" formControlName="gradeThirdsscCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  ngModel="{{cbse_marks?.ssc_Subject_fourth}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.subjectFourthsscCtrl.invalid && (ssc_form.controls.subjectFourthsscCtrl.dirty || ssc_form.controls.subjectFourthsscCtrl.touched)}" formControlName="subjectFourthsscCtrl" placeholder="Subject4" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_mark_fourth}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.markFourthsscCtrl.invalid && (ssc_form.controls.markFourthsscCtrl.dirty || ssc_form.controls.markFourthsscCtrl.touched)}" formControlName="markFourthsscCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_OutOf_fourth}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.outOfFourthsscCtrl.invalid && (ssc_form.controls.outOfFourthsscCtrl.dirty || ssc_form.controls.outOfFourthsscCtrl.touched)}" formControlName="outOfFourthsscCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input   [ngClass]="{'form-control-danger': ssc_form.controls.gradeFourthsscCtrl.invalid && (ssc_form.controls.gradeFourthsscCtrl.dirty || ssc_form.controls.gradeFourthsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_grade_fourth}}" nbInput type="text" formControlName="gradeFourthsscCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  [ngClass]="{'form-control-danger': ssc_form.controls.subjectFifthsscCtrl.invalid && (ssc_form.controls.subjectFifthsscCtrl.dirty || ssc_form.controls.subjectFifthsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_Subject_fifth}}" nbInput type="text" formControlName="subjectFifthsscCtrl" placeholder="Subject5" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_mark_fifth}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.markFifthsscCtrl.invalid && (ssc_form.controls.markFifthsscCtrl.dirty || ssc_form.controls.markFifthsscCtrl.touched)}" formControlName="markFifthsscCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" ngModel="{{cbse_marks?.ssc_OutOf_fifth}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.outOfFifthsscCtrl.invalid && (ssc_form.controls.outOfFifthsscCtrl.dirty || ssc_form.controls.outOfFifthsscCtrl.touched)}" formControlName="outOfFifthsscCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input  [ngClass]="{'form-control-danger': ssc_form.controls.gradeFifthsscCtrl.invalid && (ssc_form.controls.gradeFifthsscCtrl.dirty || ssc_form.controls.gradeFifthsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_grade_fifth}}" nbInput type="text" formControlName="gradeFifthsscCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      <div class="col-md-3"></div>
      <div class="col-md-2"><input  [ngClass]="{'form-control-danger': ssc_form.controls.subjectSixthsscCtrl.invalid && (ssc_form.controls.subjectSixthsscCtrl.dirty || ssc_form.controls.subjectSixthsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_Subject_Six}}" nbInput type="text" formControlName="subjectSixthsscCtrl" placeholder="Subject6" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" [ngClass]="{'form-control-danger': ssc_form.controls.markSixthsscCtrl.invalid && (ssc_form.controls.markSixthsscCtrl.dirty || ssc_form.controls.markSixthsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_mark_Six}}" nbInput type="text" formControlName="markSixthsscCtrl" placeholder="Marks" id="" class="form-control"></div>
      <div class="col-md-2"><input pattern="[0-9]+" [ngClass]="{'form-control-danger': ssc_form.controls.outOfSixthsscCtrl.invalid && (ssc_form.controls.outOfSixthsscCtrl.dirty || ssc_form.controls.outOfSixthsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_OutOf_Six}}" nbInput type="text" formControlName="outOfSixthsscCtrl" placeholder="Out of" id="" class="form-control"></div> OR <div
        class="col-md-2"> <input [ngClass]="{'form-control-danger': ssc_form.controls.gradeSixthsscCtrl.invalid && (ssc_form.controls.gradeSixthsscCtrl.dirty || ssc_form.controls.gradeSixthsscCtrl.touched)}" ngModel="{{cbse_marks?.ssc_grade_Six}}" nbInput type="text" formControlName="gradeSixthsscCtrl" placeholder="Grade" id="" class="form-control"> </div><br>
      ...
      <div class="col-md-9"> <input pattern="[A-Za-z0-9%+-.]+" ngModel="{{cbse_marks?.ssc_school_marks}}" nbInput type="text" [ngClass]="{'form-control-danger': ssc_form.controls.sscMarksCtrl.invalid && (ssc_form.controls.sscMarksCtrl.dirty || ssc_form.controls.sscMarksCtrl.touched)}" formControlName="sscMarksCtrl" placeholder="" id="" class="form-control"> </div><br>
    </div>
    </form>
  </nb-card-body>
  <nb-card-footer>
...
constructor(protected ref: NbDialogRef<FirstDialogComponent>,
  ...
  protected dte_api :DteApiService,) {
  ...
  private buildsscForm() : void{
    ...
    this.dte_api.getProfileValue('Education_SSC') 
      .subscribe(
        (data: any) => {  
          ...
          if(this.cbse_marks == null){
            ...
            this.result_date = new Date(data['data']['ssc_info']['ssc_result_date']);
          }
          if(!( data['data']['ssc_info'] == null || data['data']['ssc_info'] == undefined || data['data']['ssc_info'] == '' )){
            this.cbse_country = data['data']['ssc_info']['ssc_school_country'];
          }
    ...
    if(parseInt(this.ssc_form.controls.markSixthsscCtrl.value) > parseInt(this.ssc_form.controls.outOfSixthsscCtrl.value) ){
     ...
     if( this.ssc_form.valid && validation){
        var ssc_data ={
          ...
          this.dte_api.setProfileValues(ssc_data,'Education_SSC')
          .subscribe(
            (data: any) => {  
