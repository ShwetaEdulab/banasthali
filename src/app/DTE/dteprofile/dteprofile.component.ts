...
@Component({
  selector: 'ngx-dteprofile',
  templateUrl: './dteprofile.component.html',
  styleUrls: ['./dteprofile.component.scss'],
  providers:[HeaderComponent,ConfirmationService],
})
export class DTEProfileComponent {
  ...
  ngOnInit() {
    ...
    this.dte_api.checkTabs(degree,course_id).subscribe((data: any) => {
      ...
      console.log('this.tabcheck1'+this.tabcheck1)
      console.log('this.tabcheck2'+this.tabcheck2)
      console.log('this.tabcheck3'+this.tabcheck3)
      console.log('this.tabcheck4'+this.tabcheck4)
      console.log('this.tabcheck5'+this.tabcheck5)
  ...
  private buildForm1(): void {
    ...
    this.dte_api.getProfileValue('Personal')
      .subscribe(
        (data: any) => {
  ...
  private buildForm2(): void {
    ...
    this.dte_api.getProfileValue('Guardian')
      .subscribe(
        (data: any) => {
          this.guardian_info = data['data']['guardian_info'];
          if(!(this.guardian_info==null)){
          if (this.guardian_info.guardian_address_type == "Permanent") {
            this.testradio = "" + 1;
            this.Dropdownvar = 1;
           ...
           // this.secondForm.get('other_guardian_citizenship').disable();
          ...
          } else if (this.guardian_info.guardian_address_type == "temporary") {
            this.testradio = "" + 2;
            this.Dropdownvar = 2;
          ...
          } else if (this.guardian_info.guardian_address_type == "Other") {
            this.testradio = "" + 3;
            this.Dropdownvar = 3;
            ...
            this.guardian_other_address = data['data']['guardian_info']['guardian_address_country'];
            this.guardian_other_address_values = data['data']['guardian_info'];
          } else {
            this.testradio = "" + 4;
            this.Dropdownvar = 4;
          }
           this.guardianCitizenshipNumber = this.guardian_info['guardian_citizenship_number'];
          if(this.guardianCitizenshipNumber == null || this.guardianCitizenshipNumber == "null"){
            this.guardianCitizenshipNumber ='';
          }
        
        if(data['data']['guardian_info']['guardian_dob'] == null || data['data']['guardian_info']['guardian_dob'] == '' || data['data']['guardian_info']['guardian_dob'] == undefined){
          this.guardianDOB = null;
        }else{
          this.guardianDOB =  new Date(data['data']['guardian_info']['guardian_dob']);
        }
        this.guardianCountry = data['data']['guardian_info']['guardian_country_id'] ? data['data']['guardian_info']['guardian_country_id'] : null;
        } 
  ...
  public buildForm3(): void {
    ...
    this.thirdForm = this.fb.group({
      ...
      diplomaUniversityCtrl: [''],
			hscUniversityCtrl: [''],
			degreeUniversityCtrl: [''],
    });

    this.dte_api.getProfileValue('All_Education_Details')
      .subscribe(
        (data: any) => {
          if (data['data']['cbse'] != null) {
            this.cbse = data['data']['cbse'];
            this.cbse.university = data['data']['cbse']['ssc_university'];
            this.cbse.school_name = data['data']['cbse']['ssc_school_name'];
            this.cbse.result_date = data['data']['result_date'];
          } else {
          ...
          if (data['data']['hsc'] != null) {
            ...
            this.hsc.college_result_date = data['data']['college_result_date'];
          } else {
          ...
          if (data['data']['diploma'] == null) {
            ...
            this.diploma.diploma_result_date = data['data']['diploma_result_date'];        
          }
          ...
          if (data['data']['degree'] != null) {
            ...
            this.degree.degree_result_date = data['data']['degree_result_date'];
          } else {
  ...
  private buildForm4(): void {
    ...
    this.dte_api.getProfileValue('Employment')
      .subscribe(
        (data: any) => {
  ...
  onFirstSubmit(country_birth) {
    ...
    if (check_validation) {
      this.alertflag = 0;
      this.dte_api.setProfileValues(profile_data, 'Personal')
        .subscribe(
          (data: any) => {
            if(data['status']== 200){
              this.dte_api.getcheckTabs().subscribe((data: any) => {
                if(data['status'] == 200){
                }
              });
            }
  ...
  onSecondSubmit() {
    ...
    if(this.secondForm.controls.guardianMobileCtrl.value == this.profile_info.mobile && this.secondForm.controls.guardianEmailCtrl.value == this.profile_info.email){
      this.secondForm.controls.guardianMobileCtrl.markAsPending();
			this.secondForm.controls.guardianMobileCtrl.markAsTouched();
      this.secondForm.controls.guardianMobileCtrl.markAsPending();
			this.secondForm.controls.guardianMobileCtrl.markAsTouched();
			this.alertflag = 1;
			this.guardian_mobile = true;
			this.messages = "Guardian's email and mobile number should be different from student's email and mobile number";
			check_validation = false;
    }else{
			this.alertflag = 0;
      check_validation = true;
    ...
    if (this.secondForm.valid && check_validation ) {
      this.alertflag = 0;
      this.dte_api.setProfileValues(guardian_data, 'Guardian')
        .subscribe(
          (data: any) => {
            if(data['status']== 200){
              this.dte_api.getcheckTabs().subscribe((data: any) => {
  ...
  onThirdSubmit() {
    ...
    if(this.edudegreecheck == null || this.edudegreecheck == "Bachelor's" ){
      console.log('@1')
      if( !(this.cbse.university == null || this.cbse.university == '' && this.cbse == null)){
        console.log('@2')
        if(
            (   this.hsc.college_university == null|| this.hsc == null || 
                this.hsc.college_university == '')&& 
            (   this.diploma == null || this.diploma.diploma_university == null  || this.diploma.diploma_university == '')
        ){
          console.log('@3')
          this.thirdForm.controls.diplomaUniversityCtrl.setValidators([Validators.required]);
          this.thirdForm.controls.diplomaUniversityCtrl.updateValueAndValidity();
          this.thirdForm.controls.hscUniversityCtrl.setValidators([Validators.required]);
          this.thirdForm.controls.hscUniversityCtrl.updateValueAndValidity();
           console.log("ADD HSC DEGREE")
          this.eduerrorflag = 1;
          this.eduerrortext = "Please fill all mandatory fields( cbse & hsc/diploma )";
          //this.HSCDEGREEValidation = true;
        }else {
          console.log('@4')
          if(!(this.hsc.college_university == null || this.hsc.college_university == '' || this.hsc == null)){
            console.log('@7')
            this.thirdForm.controls.diplomaUniversityCtrl.clearValidators();
            this.thirdForm.controls.diplomaUniversityCtrl.updateValueAndValidity();
            this.thirdForm.controls.hscUniversityCtrl.setValidators([Validators.required]);
            this.thirdForm.controls.hscUniversityCtrl.updateValueAndValidity(); 
          ...
          }else if(!(this.diploma.diploma_university == null || this.diploma == null || this.diploma.diploma_university == '')){
            console.log('@8')
            this.thirdForm.controls.diplomaUniversityCtrl.setValidators([Validators.required]);
            this.thirdForm.controls.diplomaUniversityCtrl.updateValueAndValidity();
            this.thirdForm.controls.hscUniversityCtrl.clearValidators();
            this.thirdForm.controls.hscUniversityCtrl.updateValueAndValidity();
            this.thirdForm.patchValue({
              cbseUniversityCtrl: this.cbse.university, 
              diplomaUniversityCtrl : this.diploma.diploma_university
            }); 
            this.dte_api.getcheckTabs().subscribe((data: any) => {
            });
          }else{
          ...
          console.log('@9')
          if( this.cbse.university == '' || this.cbse == null){
            console.log('@10')
              if((this.hsc.college_university == ''|| this.hsc == null) && (this.diploma == null || this.diploma.diploma_university == '') && ( this.degree.degree_university == '' || this.degree == null)){
                console.log('@11')
                this.thirdForm.controls.diplomaUniversityCtrl.setValidators([Validators.required]);
                this.thirdForm.controls.diplomaUniversityCtrl.updateValueAndValidity();
                this.thirdForm.controls.hscUniversityCtrl.setValidators([Validators.required]);
                this.thirdForm.controls.hscUniversityCtrl.updateValueAndValidity();
                this.thirdForm.controls.degreeUniversityCtrl.setValidators([Validators.required]);
                this.thirdForm.controls.degreeUniversityCtrl.updateValueAndValidity();
                this.eduerrorflag = 1;
                this.eduerrortext = "Please fill all mandatory fields( cbse & hsc/diploma )";
                //this.HSCDEGREEValidation = true;
              }else {
                ...
                this.thirdForm.controls.hscUniversityCtrl.clearValidators();
                this.thirdForm.controls.hscUniversityCtrl.updateValueAndValidity();
                this.thirdForm.controls.degreeUniversityCtrl.clearValidators();
                this.thirdForm.controls.degreeUniversityCtrl.updateValueAndValidity();
                this.thirdForm.patchValue({
                  cbseUniversityCtrl: this.cbse.university, 
                  hscUniversityCtrl : this.hsc.college_university,
            ...
            }else if(!(this.cbse.university == '' && this.cbse == null)){
              console.log('@13')
              if((this.hsc.college_university == '' || this.hsc == null) && (this.diploma == null || this.diploma.diploma_university == '') && (this.degree.degree_university == '' || this.degree == null)){
                console.log('@14')
                this.thirdForm.controls.diplomaUniversityCtrl.setValidators([Validators.required]);
                ...
                this.eduerrortext = "Please fill all mandatory fields( cbse & hsc/diploma )";
                //this.HSCDEGREEValidation = true;
              }else if(!(this.hsc.college_university == '' || this.hsc == null)){
                console.log('@15')
                this.thirdForm.controls.diplomaUniversityCtrl.clearValidators();
                this.thirdForm.controls.diplomaUniversityCtrl.updateValueAndValidity();
                this.thirdForm.controls.hscUniversityCtrl.setValidators([Validators.required]);
              ...
              }else if(!(this.diploma == null || this.diploma.diploma_university == '')){
                console.log('@16')
                this.thirdForm.controls.diplomaUniversityCtrl.setValidators([Validators.required]);
                this.thirdForm.controls.diplomaUniversityCtrl.updateValueAndValidity();
                this.thirdForm.controls.hscUniversityCtrl.clearValidators();
        ...
        if(
          ...
          this.thirdForm.controls.hscUniversityCtrl.setValidators([Validators.required]);
          this.thirdForm.controls.hscUniversityCtrl.updateValueAndValidity(); 
          this.thirdForm.controls.cbseUniversityCtrl.setValidators([Validators.required]);
          this.thirdForm.controls.cbseUniversityCtrl.updateValueAndValidity(); 
          console.log("ADD HSC DEGREE")
          this.eduerrorflag = 1;
          this.eduerrortext = "Please fill all mandatory fields( cbse & hsc/diploma )";
          //this.HSCDEGREEValidation = true;
        }else 
        {
          ...
          }else if(!(this.diploma.diploma_university == null || this.diploma.diploma_university == '' || this.diploma == null )){
            console.log('@8')
            this.thirdForm.controls.diplomaUniversityCtrl.setValidators([Validators.required]);
            this.thirdForm.controls.diplomaUniversityCtrl.updateValueAndValidity();
            this.thirdForm.controls.hscUniversityCtrl.clearValidators();
        ...
        .subscribe(
          (data: any) => {
            ...
            if (data !== undefined) {
              ...
              this.cbse.ssc_school_marks = data.sscMarks;
            }
            this.eduerrorflag = 0;
            //this.next_disable();
            err => console.error(err)
  ...
  delete_education_details(type) {
    this.dte_api.delete_education(type)
      .subscribe(
        (data: any) => {
          this.dte_api.getcheckTabs().subscribe((data: any) => {
            if(data['status'] == 200){
  ...
  Letter(userId) {
    this.dte_api.previewLetter(userId)
      .subscribe(
        (data: any) => {
  ...
  deleteTranscript(name, userId, transcriptId, LoadNo) {
    ...
    this.dte_api.deleteTranscripts(name, userId, transcriptId)
      .subscribe(data => {
          if(data['status'] == '400'){
  ...
  quickApply() {
    this.router.navigate(['pages/DTESearch']);
  ...
  save_employment_details(): void {
    ...
    if (validation) {
      this.dte_api.setProfileValues(emp, "Employment").subscribe(data => {
        this.ngOnInit();
        this.stepper.selectedIndex = 3;
  ...
  delete_employment_details(id): void {
    this.dte_api.delete_employment(id).subscribe(data => {
      this.buildForm4();
  ...
  setMobileCountryCode(event: any){
		...
		this.Countries.forEach(element => {
			if(element.id == event){
				this.guardian_info.guardian_mobile_country_code = element.phonecode;
				this.guardian_info.guardian_mobile ="";
			}
		});
...
//   styleUrls: ['./dteprofile.component.scss']
// })
// export class DTEProfileComponent implements OnInit {
