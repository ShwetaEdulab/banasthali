...
import { DTETermsComponent } from './terms.component';
import { DomSanitizer, SafeHtml } from '@angular/platform-browser';
import {ConfirmationService} from 'primeng/api';
import { DTEConfirmPassComponent } from './confirmPass.component';
...
export class DTERegisterComponent{
	email:any;
  ...
  constructor(
								...
								.subscribe(
									(data: any) => {
										if(data['status'] == 200){
											...
											this.emailAlert = false;
											this.dialogService.open(DTEConfirmPassComponent, {
												//hasBackdrop : false,
												//autoFocus : true,
												context: {
    ...
    this.RegisterForm.controls.genderCtrl.markAsDirty();     
      ...
      if(difference < 16){
		...
		if(check_validation){
			this.alertflag = 0;
				this.dialogService.open(DTETermsComponent, {
