...
import { DTERegisteredComponent } from './registered.component';
...
@Component({
    ...
    export class DTETermsComponent {
        ...
        alert;
        user_id: any;
            constructor(protected ref: NbDialogRef<DTETermsComponent>,
                    ...
                    this.api.RegisterValues(register_data)
                            .subscribe(
                                ...
                                if(data['status'] == 200){
                                        ...
                                        this.ref.close();
                                        this.dialogService.open(DTERegisteredComponent, {
