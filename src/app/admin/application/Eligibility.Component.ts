...
@Component({
            ...
            <nb-card accent="info">
                ...
                <nb-card-body >
                    ...
                    <div *ngIf="courses_list?.length > 0">
                        <div>
                        <h5 class="text-center"><font color="green">Following Courses are applied by above mumbai eligible students:-</font></h5>
                        </div>
                    ...
                    <br>
                    <br>
                    <h4 class="text-center"><font color="green">Pune University Eligible Students</font></h4>
                    <div *ngIf="pune_data != undefined;else pune_not_exists">
                        <table class="table table-striped w-auto" *ngIf="pune_data.length > 0">
                        <thead>
                            <tr>
                                <th>Student Name :</th>
                                <th>Student Email :</th>
                        ...
                        <tbody>
                            <tr *ngFor="let data of pune_data">
                                <td>{{data.stu_name}}</td>
                                <td>{{data.stu_email}}</td>
                                <td>IC/P/{{data.eligib_number}}</td>
                                <td><button nbButton outline style="cursor: pointer;" (click)="openpuneeligibilityletter(data.pdf,data.applicationId)">Download</button></td>
                            </tr>
                        </tbody>
                        </table>
                        <br>
                        <br>
                        <div *ngIf="pune_courses?.length > 0">
                            <div>
                            <h5 class="text-center"><font color="green">Following Courses are applied by above pune eligible students:-</font></h5>
                            </div>
                            <table class="table table-striped w-auto" *ngIf="pune_courses?.length > 0">
                            <thead>
                                <tr>
                                    <th>Course Name :</th>
                                    <th>Course Specialization :</th>
                            ...
                            <tbody>
                                <tr *ngFor="let data of pune_courses">
                                    <td>{{data.name}}</td>
                                    <td>{{data.specialization}}</td>
                                </tr>
                            </tbody>
                    ...
                    <ng-template #pune_not_exists>
                        <div class="row userDetailsRow wordWrap">
                            <div class="col-md-6 offset-md-3 ">
                                <h5 class="text-center"><font class="text-center" color="red">No Records Found in Pune!!</font></h5>
                            </div>
                        </div>
                    </ng-template>
                    </div>
    ...
    export class EligibilityComponent {
        ...
        user_id: any;
            ...
            openpuneeligibilityletter(pdf,applicationId){
