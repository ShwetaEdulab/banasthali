...
export class AdminForeignOfficeComponent {
 ...
 // @ViewChild('embassyEmail') input :ElementRef; 
  ...
  getThirdPaymentDetails(value,t_paymentMode,amount,currency,transaction_id,dateOfPayment,challanExist,challan,third_split,user_id){
  ...
  thirdPaymentExcel(){
    //this.selectedYear
    this.adminApi.thirdPaymentExcel(this.selectedYear).subscribe(data=> { 
      var value = data['data'];
