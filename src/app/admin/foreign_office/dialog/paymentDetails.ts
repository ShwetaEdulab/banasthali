        ...
        <thead>
            ...
            <tr>
                ...
                <td style="width: 60%;padding: 8px;">
                   ...
                   <a  (click)="downloadChallan(trans1.challanName);"  *ngIf="!(trans1?.challanExist == false)">Download</a>
                </td>
            </tr>
        </thead>
    </table>
        ...
        <thead>
            ...
            <tr>
                ...
                <td style="width: 60%;padding: 8px;">
                   ...
                   <a  (click)="downloadChallan(trans2.challanName);"  *ngIf="!(trans2?.challanExist == false)">Download</a>
                </td>
            </tr>
        </thead>
    </table>
