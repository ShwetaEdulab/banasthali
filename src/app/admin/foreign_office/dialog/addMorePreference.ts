...
<nb-card-header>
<div class="row">
  <div class="col-md-8" style="text-align:center;">Other College List </div>
    <button class="col-md-2" style="float:right;" nbButton shape="semi-round" size="xsmall" hero status="primary" (click)="collegeAllocation()">Save</button>
    <div class="col-md-1"></div>
    <button class="col-md-1" style="float:right;" nbButton shape="semi-round" size="xsmall" outline class="closeBtn ion-close-round" (click)="dismiss()"></button>
  ...
  <nb-card-body>
    ...
    <div class="row">
        <table class="table-bordered" >
            ...
            <br>
            <tbody>
                <tr *ngFor="let data of colleges | filter:{collegename:filterText,short_form:filterText}" >
                    <th>
                        <p>
