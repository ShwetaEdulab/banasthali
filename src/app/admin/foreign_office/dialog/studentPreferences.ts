...
<div class="row">
    ...
    <button class="col-md-2" style="float:right;" size="xsmall" nbButton hero status="primary" style="margin-left:15px;" *ngIf="college_length > 5" (click)="open()" >Add More</button>
    
    <button class="col-md-1" style="float:right;" size="xsmall" nbButton hero status="primary" style="margin-left:15px;" (click)="collegeAllocation()" >Save</button>
