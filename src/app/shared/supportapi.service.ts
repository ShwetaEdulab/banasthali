...
export class SupportapiService {
  ...
  private supportBaseUrl = 'http://banasthali.admissiondesk.org/support';
  ...
  getAttachment(uid){
    try{
      return  this.httpClient.get(`${this.baseUrl}/api/support/getAttachment?ticket_id=`+uid);
    }catch(error) {
      this.handleError("getAttachment : "+error);
    }  
  }
