    ...
    template: `
       <nb-card class="col-md-6 offset-md-3" style ="font-size: 16px;" [style.overflow]="'auto'" [style.height.px]="'500'">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                <nb-checkbox status="success" value="true">
                The Banasthali Vidyapith may communicate with me by mail, email, phone or text message about my account and other information relevant to the admission application process (you can change this response later within your account settings).
                </nb-checkbox>
            </div>
        </div><br>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                <nb-checkbox status="success">
                    The Banasthali Vidyapith website uses small files stored on your computer, known as cookies, that help us remember your settings and ensure the website works properly. By continuing, I am agreeing to The Mumbai University's use of cookies.
                </nb-checkbox>
            </div>
		</div> 		
