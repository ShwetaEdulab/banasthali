...
import { DTEOtpComponent } from './DTE/auth/register/otp.component';
import { DTERegisteredComponent } from './DTE/auth/register/registered.component';
import { DTETermsComponent } from './DTE/auth/register/terms.component';
import { DTEConfirmPassComponent } from './DTE/auth/register/confirmPass.component';
...
//});
//const socketconfig: SocketIoConfig = { url: 'http://banasthali.admissiondesk.org', options: {reconnection: true,transports: ['websocket'],secure: true} };
const socketconfig: SocketIoConfig = { url: 'http://banasthali.admissiondesk.org:2', options: {} };
...
@NgModule({
  declarations: [AppComponent,
    ...
    //DTE
    DTERegisterComponent,
    DTEOtpComponent,
    DTERegisteredComponent,
    DTETermsComponent,
    DTEConfirmPassComponent,
    ],
  imports: [
    BrowserModule,
